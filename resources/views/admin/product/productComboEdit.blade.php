                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select required class="form-control selectpicker" name="unit_id"
                                                        ...
                                                        <option {{ $data->unit_id == '1' ? 'selected' : '' }}
                                                            value="1">Piece</option>
                                                        <option {{ $data->unit_id == '2' ? 'selected' : '' }}
                                                            value="2">Meter</option>
                                                        <option {{ $data->unit_id == '3' ? 'selected' : '' }}
                                                            value="3">Kilogram</option>
...
<input type="text" name="variant" class="form-control" placeholder="Enter variant seperated by comma">
</div>
